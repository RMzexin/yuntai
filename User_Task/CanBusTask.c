...
*Input         :can message
*Return        :void
*Description   :to get the initial encoder of the chassis motor 201 202 203 204
*
*
***********************************************************************************************
*/
...
/**
  * @brief  Filter values that vary less   
  *  
  * @param  Encoder pointer        
  *
  * @retval Pitch Filtered value
  */
...
void EncoderProcess(volatile Encoder *v, CanRxMsg * msg)
{
  ...
  if(msg->StdId>=0x201||msg->StdId<=0x204)
	{
		if(msg->Data[2] & 128)
			{		
			v->rotor_speed =(~(65535-((msg->Data[2]<<8)|msg->Data[3]))/19);
			}
			else
			{
				v->rotor_speed =(((msg->Data[2]<<8)|msg->Data[3])/19);				
			}
	}	
